...
SELECT Customer.cust_name AS "Customers", Customer.grade AS "Grade"
FROM Orders 
JOIN Salesman ON ORDERS.Salesman_id = Salesman.Salesman_id
JOIN Customers ON ORDERS.Customers_id = Customers.Customers_id
WHERE Customer.grade IS NOT NULL;

SELECT Customer.cust_name AS Customers
Customer.city AS "City",
Salesman.sales AS "Salesman",
Salesman.Comission
FROM Customer
JOIN Salesman ON Customer.Salesman_id = Salesman.Salesman_id
...
SELECT Orders.ord_no, Customer.cust_name, Salesmna.Comission AS "Comission%"
